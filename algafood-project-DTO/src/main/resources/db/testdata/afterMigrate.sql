...
(2, 'Flavia Furlaneto', 'flavia.furlaneto@algafood.com', '123', utc_timestamp),
(3, 'Hanna Vira', 'hanna.vira@algafood.com', '123', utc_timestamp),
...
values (1, 'e5d4187f-b73d-4fb0-bacc-2a72c06eb776', 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
        endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
        status, data_criacao, subtotal, taxa_frete, valor_total)
values (2, '54274bfd-41d0-47e4-8b55-2db4dcbd35af', 4, 1, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro',
