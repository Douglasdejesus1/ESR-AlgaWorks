...
import com.douglas.algafood.api.assembler.ProdutoInputDisassembler;
import com.douglas.algafood.api.assembler.ProdutoModelAssembler;
import com.douglas.algafood.api.model.ProdutoModel;
import com.douglas.algafood.api.model.input.ProdutoInput;
...
public class RestauranteProdutosController {
	...
	public ProdutoModel buscar( @PathVariable("restauranteId") Long restauranteId, @PathVariable("produtoId") Long produtoId) {
